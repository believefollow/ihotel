...
export class CheckinComponent implements OnInit {
  ...
  trackId(index: number, item: ICheckin): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICheckin[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
