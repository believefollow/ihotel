...
export class AuditinfoComponent implements OnInit {
  ...
  protected onSuccess(data: IAuditinfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    if (navigate) {
      this.router.navigate(['/auditinfo'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
