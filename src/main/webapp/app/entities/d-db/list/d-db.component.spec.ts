...
import { DDbComponent } from './d-db.component';

describe('Component Tests', () => {
  describe('DDb Management Component', () => {
    let comp: DDbComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dDbs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
