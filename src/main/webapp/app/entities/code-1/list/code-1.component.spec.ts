...
import { Code1Component } from './code-1.component';

describe('Component Tests', () => {
  describe('Code1 Management Component', () => {
    let comp: Code1Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Code1Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.code1s?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
