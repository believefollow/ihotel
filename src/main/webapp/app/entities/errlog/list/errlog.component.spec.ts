...
describe('Component Tests', () => {
  describe('Errlog Management Component', () => {
    let comp: ErrlogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ErrlogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.errlogs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
