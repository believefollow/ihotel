...
import { DTypeComponent } from './d-type.component';

describe('Component Tests', () => {
  describe('DType Management Component', () => {
    let comp: DTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dTypes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
