...
describe('Component Tests', () => {
  describe('Classreport Management Component', () => {
    let comp: ClassreportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClassreportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.classreports?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
