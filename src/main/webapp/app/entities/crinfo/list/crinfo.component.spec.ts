...
describe('Component Tests', () => {
  describe('Crinfo Management Component', () => {
    let comp: CrinfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CrinfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.crinfos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
