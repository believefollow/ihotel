...
import { BookingtimeComponent } from './bookingtime.component';

describe('Component Tests', () => {
  describe('Bookingtime Management Component', () => {
    let comp: BookingtimeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookingtimeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookingtimes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
