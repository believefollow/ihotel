...
/**
 * Criteria class for the {@link ihotel.app.domain.FtXzs} entity. This class is used
 * in {@link ihotel.app.web.rest.FtXzsResource} to receive all the possible filtering options from
 ...
 */
public class FtXzsCriteria implements Serializable, Criteria {
    ...
    public FtXzsCriteria() {}

    public FtXzsCriteria(FtXzsCriteria other) {
        this.id = other.id == null ? null : other.id.copy();
        this.roomn = other.roomn == null ? null : other.roomn.copy();
    }

    @Override
    public FtXzsCriteria copy() {
        return new FtXzsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FtXzsCriteria that = (FtXzsCriteria) o;
