...
/**
 * Criteria class for the {@link ihotel.app.domain.DEmpn} entity. This class is used
 * in {@link ihotel.app.web.rest.DEmpnResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /d-empns?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DEmpnCriteria implements Serializable, Criteria {

    private static final long serialVersionUID = 1L;

    private LongFilter id;

    private LongFilter empnid;
    ...
    public DEmpnCriteria() {}

    public DEmpnCriteria(DEmpnCriteria other) {
    ...
    @Override
    public DEmpnCriteria copy() {
        return new DEmpnCriteria(this);
    }
    ...
    public LongFilter getEmpnid() {
        return empnid;
    }

    public LongFilter empnid() {
        if (empnid == null) {
            empnid = new LongFilter();
        }
        return empnid;
    }

    public void setEmpnid(LongFilter empnid) {
        this.empnid = empnid;
    }
    ...
    public boolean equals(Object o) {
        ...
        final DEmpnCriteria that = (DEmpnCriteria) o;
        return (
